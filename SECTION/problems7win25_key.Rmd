...
so that the sum of the areas of the blocks equals 1. (The $n$ represents the total number of observations in the dataset.)
    ...
    The are of a block in a density histogram is the proportion of values which fall in the bin. Namely: 
    
    $$area = density \times width = \frac{frquency}{n}$$.
    
    The area of the blocks in a density histogram  sum to 1 because we are adding 
    up the proportion of observations which fall in each bin.  
