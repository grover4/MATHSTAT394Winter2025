...
We can write this as $P( 4\leq X\leq 10) = P(X=4)+P(X=5)+P(X=6)+P(X=7)+P(X=8)+P(X=9)+P(X=10) = P(X\leq 10) - P(X<3)$.
...
What about $P(4<X<10)=P(X=5)+P(X=6)+P(X=7)+P(X=8)+P(X=9) = P(X\leq 10) - P(X<3)$?
