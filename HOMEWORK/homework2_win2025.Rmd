...
e. If all went well, your graph should be unimodal with a peak at $N=100$. Just conceptually, explain why this pattern - probability increasing for $N < 100$ and decreasing thereafter - is reasonable.

    Hint: since the sample is picked randomly, the most likely samples are the ones where the proportion of tagged fish in the sample is close to the proportion of tagged fish in the population.
